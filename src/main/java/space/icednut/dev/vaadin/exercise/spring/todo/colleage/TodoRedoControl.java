 ...
 * @date 31/08/2019
 **/
public class TodoRedoControl extends Button implements TodoAppParticipant {

    private final IMediator mediator;

    public TodoRedoControl(IMediator mediator, TodoAppEventListener<? extends TodoAppParticipant> actionListener) {
